    ...
    return (
        <div className="min-h-screen bg-[#F8FAFC] pb-24 font-inter text-slate-800">
            <div className="max-w-[1400px] mx-auto px-8 pt-8">
                <Link href="/networking" className="inline-flex items-center gap-2 text-[13px] font-semibold text-slate-500 hover:text-slate-900 transition-colors mb-6">
                    <ArrowLeft size={16} /> Back to Smart Connect
                </Link>

                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                    <div>
                        <h1 className="text-[24px] font-bold text-slate-900 leading-tight mb-1">
                            Lead Management (CRM)
                        </h1>
                        <p className="text-[14px] text-slate-500">Manage and track contacts captured from your networking cards.</p>
                    </div>

                    <div className="flex items-center gap-3">
                        <button onClick={exportCSV} className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 rounded-xl text-[13px] font-semibold text-slate-700 hover:bg-slate-50 transition-colors shadow-sm">
                ...
                <div className="flex flex-col md:flex-row gap-4 mb-6">
                    <div className="relative flex-1 max-w-md">
                        ...
                        <input 
                            ...
                            className="w-full pl-10 pr-4 py-2.5 bg-white border border-slate-200 rounded-xl text-[13px] focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all shadow-sm"
                        />
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                        <div className="relative">
                            <select 
                                ...
                                className="appearance-none pl-10 pr-8 py-2.5 bg-white border border-slate-200 rounded-xl text-[13px] font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 cursor-pointer shadow-sm"
                            >
                                        ...
                                        <tr key={lead.id} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        <div className="text-[14px] font-bold text-slate-900">{lead.name}</div>
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center gap-2 text-[13px] font-semibold text-slate-900 mb-0.5">
                                                    <Building2 size={14} className="text-slate-400" /> {lead.company || 'Unknown Company'}
                                                </div>
                                                <div className="text-[12px] text-slate-500 ml-6">

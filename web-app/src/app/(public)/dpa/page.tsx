...
* **Controller:** The business, organization, or individual ("Customer," "you," "Controller") that has agreed to the NobleInvoice Terms of Service and uses the NobleInvoice platform to process personal data.
* **Processor:** The Noble's Technology Service, CAC-registered, Lagos, Nigeria, operating the NobleInvoice platform ("NobleInvoice," "we," "Processor").

This DPA applies where NobleInvoice processes **personal data on behalf of the Customer** as a data processor, specifically the personal data of the Customer's clients, contacts, employees, or other data subjects that the Customer uploads, stores, or processes through the NobleInvoice platform ("Customer Personal Data").

This DPA forms part of and is incorporated into the NobleInvoice [Terms of Service](https://invoice.noblesworld.com.ng/terms). In the event of a conflict between this DPA and the Terms of Service in matters relating to data processing, this DPA prevails.

**This DPA is incorporated into the Terms of Service by reference and applies automatically to all NobleInvoice customers who process personal data through the platform.** Enterprise customers who require a signed bilateral DPA should contact legal@noblesworld.com.ng.
...
* **"Processor"** means the entity that processes Personal Data on behalf of the Controller. In the context of this DPA, NobleInvoice is the Processor.
...
* The Customer is responsible for the accuracy and legality of the Customer Personal Data it uploads to NobleInvoice.

**NobleInvoice as Processor:**
* NobleInvoice processes Customer Personal Data only on the documented instructions of the Customer, as set out in this DPA and the Terms of Service.
* NobleInvoice does not sell Customer Personal Data or use it for its own independent commercial purposes.
* NobleInvoice does not make independent decisions about Customer Personal Data beyond what is necessary to provide the Service.

**Independent Controller scenarios:**
* Where NobleInvoice processes data about the Customer's own Account (registration data, subscription data, payment information for billing NobleInvoice's own subscription), NobleInvoice acts as an independent Controller. This processing is described in the [Privacy Policy](https://invoice.noblesworld.com.ng/privacy).

---

### 4. SUBJECT MATTER AND INSTRUCTIONS

**Subject matter:** The processing of Customer Personal Data stored by the Customer in the NobleInvoice platform, including but not limited to client contact information, invoice records, and payment transaction references.

**Instructions:** NobleInvoice is instructed to process Customer Personal Data for the following purposes:
* Storing Customer Personal Data in the NobleInvoice database on behalf of the Customer.
...
* Complying with legal obligations applicable to NobleInvoice as Processor.

NobleInvoice will not process Customer Personal Data for any purpose beyond those described above unless required by applicable law, in which case NobleInvoice will inform the Customer unless prohibited by law.

If the Customer provides instructions that NobleInvoice reasonably believes would violate applicable data-protection law, NobleInvoice will inform the Customer.

---

### 5. NATURE, PURPOSE, AND DURATION

**Nature of processing:** Storage, retrieval, formatting, transmission (for invoice delivery), and deletion of Customer Personal Data within the NobleInvoice platform.

**Purpose:** To enable the Customer to operate its invoicing, CRM, and business management workflows using the NobleInvoice platform.
...
Customer Personal Data processed through the NobleInvoice platform may include:
...
The Customer controls what categories of Personal Data it uploads to NobleInvoice. NobleInvoice does not determine the categories of Personal Data the Customer chooses to store.

**Special categories of personal data:** NobleInvoice's platform is not designed or intended for the storage of special categories of personal data (as defined under GDPR Article 9 or NDPA equivalents), including health data, racial or ethnic origin, religious beliefs, or criminal records. The Customer must not upload special-category data to NobleInvoice.
...
* Third parties who sign contracts through the NobleInvoice e-signature feature.
* Third parties who scan QR codes created by the Customer using NobleInvoice.

---

### 8. PROCESSOR OBLIGATIONS

NobleInvoice, as Processor, undertakes to:
...
NobleInvoice implements the following technical and organisational security measures for Customer Personal Data:
...
* Tokenized payment architecture — full cardholder data is not stored by NobleInvoice.
...
* Internal access-control policies for NobleInvoice staff.
* Responsible disclosure vulnerability reporting process.
* Audit logging of critical account and administrative actions.

A full description of security measures is available in the [Security Policy](https://invoice.noblesworld.com.ng/security).

---

### 10. SUB-PROCESSORS

The Customer authorises NobleInvoice to engage the sub-processors listed in the [Subprocessor List](https://invoice.noblesworld.com.ng/subprocessors), which is incorporated into this DPA by reference.
...
* Remain liable to the Customer for the acts and omissions of its sub-processors to the same extent NobleInvoice would be liable if it performed the processing directly.
...
The Customer acknowledges that, by using NobleInvoice, Customer Personal Data will be transferred to and processed in the United States and other jurisdictions, subject to these safeguards.
...
**NobleInvoice's assistance:** To the extent technically feasible and within the capabilities of the platform, NobleInvoice will assist the Customer in responding to data-subject rights requests:
* The Customer can export Customer Personal Data using the in-app export functionality (where available).
* The Customer can delete clients, invoices, and other records directly through the NobleInvoice interface.
...
**NobleInvoice's own data subjects:** Data-subject rights relating to NobleInvoice's processing of the Customer's own Account data (as independent Controller) should be directed to privacy@noblesworld.com.ng.

---

### 13. DATA BREACH NOTIFICATION

If NobleInvoice becomes aware of a Security Incident affecting Customer Personal Data, NobleInvoice will:
...
NobleInvoice's notification to the Customer does not constitute an admission of fault or liability.

The Customer is responsible for notifying the relevant Supervisory Authority and affected data subjects as required by applicable law, based on the information provided by NobleInvoice.

---

### 14. AUDIT RIGHTS

The Customer may, at its own expense and upon reasonable written notice (at least 30 days), exercise audit rights regarding NobleInvoice's processing of Customer Personal Data, subject to the following:

* Audits must be conducted during business hours and must not unreasonably disrupt NobleInvoice's operations.
* Audits may not involve direct access to systems containing other customers' data.
* NobleInvoice may satisfy audit obligations by providing relevant documentation, certifications, or third-party audit reports where available.
...
* Upon Account deletion initiated by the Customer, Customer Personal Data will be deleted through NobleInvoice's deletion pipeline (the \`cleanup-user-data\` process) within a commercially reasonable period.
...
**Return of data:** Where technically available, the Customer may export Customer Personal Data via the in-app export functionality before Account deletion. NobleInvoice is not obligated to maintain data in a specific format for export purposes.
...
The Customer agrees to indemnify NobleInvoice against claims, fines, or penalties imposed by a Supervisory Authority or third party arising from the Customer's failure to comply with applicable data-protection law in its role as Controller, including failure to provide appropriate privacy notices to data subjects or failure to establish a lawful basis for processing.
...
export default function DPAPage() {
  return (
    <LegalLayout
      ...
      description="This DPA governs how NobleInvoice processes personal data on behalf of business customers. It applies automatically to all customers and sets out the obligations of both parties under NDPA, GDPR, and applicable data-protection law."

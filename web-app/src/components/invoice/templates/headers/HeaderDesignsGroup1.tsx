  ...
  return (
    <div className="relative pt-12 px-16 z-10 flex flex-col pl-40">
       <div className="flex justify-between items-end mb-16">
          <div>
             <h1 className="text-7xl font-black uppercase text-noble-text tracking-tighter leading-none">INVOICE</h1>
  ...
  return (
    <div className="relative pt-12 px-16 z-10 flex flex-col">
       <div className="flex justify-between items-center mb-16">
          ...
          <div className="text-right">
             <h1 className="text-6xl font-black uppercase text-noble-text tracking-tighter italic underline decoration-[#06B6D4] decoration-8 underline-offset-8">INVOICE</h1>
          </div>
       </div>
    </div>
  );
    ...
    <div className="relative pt-12 px-16 z-10 flex flex-col">
       <div className="flex justify-between items-center mb-16 bg-noble-surface/50 backdrop-blur-md p-8 rounded-[4rem] border border-white/20 shadow-xl">
          ...
          <div className="bg-[#FBBF24] px-10 py-4 rounded-full shadow-lg">
             <h1 className="text-3xl font-black uppercase text-noble-text tracking-widest">INVOICE</h1>
          </div>
       </div>
    </div>
  );

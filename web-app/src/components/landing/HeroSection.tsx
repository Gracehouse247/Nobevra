                ...
                <div className="max-w-[1430px] mx-auto px-4 md:px-16 w-full grid lg:grid-cols-[1.1fr_0.9fr] gap-16 items-center">
                    ...
                    >
                        ...
                        <h1 className="font-inter text-near-black mb-6 text-[30px] md:text-[50px] leading-[1.05] tracking-tight font-black">
                            Finally, Invoice Software for Small Business That Actually Understands{' '}
                            <span className="text-noble-blue">Cash Flow</span>
                        </h1>

                        <p className="text-body-lg text-near-black/60 max-w-xl mb-10 leading-relaxed">
                            Most billing tools are built for accountants. We built this for you. Get paid faster, stop chasing clients, and manage your money without needing a finance degree.
                        </p>
                    ...
                    >
                        ...
                        >
                            ...
                            <div>
                                <p className="text-[9px] font-black text-near-black/60 uppercase tracking-widest">Active Now</p>
                                <p className="text-[11px] font-bold text-near-black">Global Users</p>
                            </div>
                        </motion.div>
                    </motion.div>
                </div>

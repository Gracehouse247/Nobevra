    ...
    return pw.Column(children: [
      ...
      pw.Padding(
        ...
        child: pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
          ...
          pw.Center(child: pw.Text('Generated by Nobevra — nobevra.com', style: pw.TextStyle(font: bold, fontSize: 6, color: PdfColors.grey400, letterSpacing: 0.5))),
        ...
        child: pw.Column(mainAxisAlignment: pw.MainAxisAlignment.end, children: [
           pw.Padding(
             ...
             child: pw.Transform.rotate(
                angle: -1.5708,
                child: pw.Text('Nobevra INVOICING', style: pw.TextStyle(font: bold, color: PdfWidgets.applyOpacity(PdfWidgets.getContrastColor(darkAccent), 0.3), fontSize: 12, letterSpacing: 4)),
             ),
           ),
        ]),
      ),
